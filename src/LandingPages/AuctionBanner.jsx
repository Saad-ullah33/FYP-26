...
export const AuctionBanner = () => {
  return (
    <div className="relative py-20 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto px-6 py-2">
        
        {/* Card 1: Verified Dealers */}
        <div className="bg-white hover:bg-slate-50/50 border border-slate-100 hover:border-slate-200 rounded-2xl p-6 flex flex-col items-center text-center transition-all duration-300 shadow-sm hover:shadow-xl hover:shadow-slate-100/60 hover:-translate-y-1.5 group">
